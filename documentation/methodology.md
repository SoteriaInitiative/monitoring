...
| Recovered Assets                      | FIU Reports                                 | [Per country](../data/data_sources.csv)       | Annual FIU reports are the official publication of all SAR/STR counts, ensuring consistency and comparability year-to-year for that country.                       |
